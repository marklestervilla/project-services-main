                                    ...
                                    <form action="code-proj.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="workers[]" class="mySelect2 form-control mb-3" multiple="multiple" size="5">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="productivityDescription" name="description" rows="3" placeholder="Enter description"><?= $productivity['description'] ?></textarea>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control" name="start_date" required value="<?= date('Y-m-d\TH:i', strtotime($productivity['start_duration'])) ?>" />
                                                <label for="">End Duration</label>
                                                <input type="datetime-local" class="form-control" name="due_date" required value="<?= date('Y-m-d\TH:i', strtotime($productivity['end_duration'])) ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
